...
class Zita_Site_Library_WXR_Importer {

	/**
	 * Instance of Zita_Site_Library_WXR_Importer
	 *
	 * @since  1.0.0
	 * @var Zita_Site_Library_WXR_Importer
	 */
	private static $_instance = null;

	/**
	 * Instantiate Zita_Site_Library_WXR_Importer
	 *
	 * @since  1.0.0
	 * @return (Object) Zita_Site_Library_WXR_Importer.
	 */
	...
	private function __construct() {
		...
		if ( ! class_exists( 'WP_Importer_Logger' ) ) {
			require_once ZITA_SITE_LIBRARY_DIR . 'wxr-importer/class-logger.php';
		}

		if ( ! class_exists( 'WP_Importer_Logger_ServerSentEvents' ) ) {
			require_once ZITA_SITE_LIBRARY_DIR . 'wxr-importer/class-wp-importer-logger-serversentevents.php';
		}

		if ( ! class_exists( 'WXR_Importer' ) ) {
			require_once ZITA_SITE_LIBRARY_DIR . 'wxr-importer/class-wxr-importer.php';
		}

		if ( ! class_exists( 'WXR_Import_Info' ) ) {
			require_once ZITA_SITE_LIBRARY_DIR . 'wxr-importer/class-wxr-import-info.php';
		}
...
Zita_Site_Library_WXR_Importer::instance();
